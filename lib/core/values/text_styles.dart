...
const yellowText16 = TextStyle(
  fontSize: 16,
  fontWeight: FontWeight.w400,
  color: AppColors.textColorYellow,
);

const yellowText35 = TextStyle(
  fontSize: 32,
  fontWeight: FontWeight.w400,
  color: AppColors.textColorYellow,
);
...
final labelCyanStyle = labelStyle.copyWith(color: AppColors.textColorYellow);
...
const pageTitleStyleCustomFont = TextStyle(
  fontSize: 18,
  fontWeight: FontWeight.w600,
  height: 1.15,
  color: AppColors.appBarTextColor,
...
final extraBigTitleCyanStyle =
    extraBigTitleStyle.copyWith(color: AppColors.textColorYellow);
...
final bigTitleCyanStyle =
    bigTitleStyle.copyWith(color: AppColors.textColorYellow);
...
final boldTitleCyanStyle =
    boldTitleStyle.copyWith(color: AppColors.textColorYellow);
