  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Começar um novo trabalho', style: TextStyle(fontSize: 25, color: Colors.black)),
        leading: IconButton(
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: const [
                              TextField(decoration: InputDecoration(labelText: 'Nome do Trabalho'), style: TextStyle(fontSize: 15)),
                              SizedBox(height: 10),
                              TextField(decoration: InputDecoration(labelText: 'Descriçao'), style: TextStyle(fontSize: 15)),
                            ],
                          ),
                        ),
                      ),
