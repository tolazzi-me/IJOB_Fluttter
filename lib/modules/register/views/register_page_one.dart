...
class RegisterPage extends State<RegisterPageMain> with CustomValidations {
  ...
  bool _obscureRepeatPasswordText = true;
  bool termos = false;
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: GestureDetector(
                              onTap: () {
                                setState(() => _obscureRepeatPasswordText = !_obscureRepeatPasswordText);
                              },
                              child: Icon(
                                _obscureRepeatPasswordText ? Icons.visibility : Icons.visibility_off,
                              ),
                            ),
                          ),
                          ...
                          obscureText: _obscureRepeatPasswordText,
                        ),
                          ...
                          children: [
                            ...
                            TextButton(
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                  fontSize: 16,
                                  color: termos ? Colors.black : Colors.redAccent,
