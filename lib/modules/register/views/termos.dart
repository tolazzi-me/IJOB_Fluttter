        ...
        body: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              children: const [
                Text(
                    'Você deve ler e concordar com nossos termos de uso (o "contrato"), pois este constitui o contrato vinculativo entre você e o I-JOB.  '),
                SizedBox(height: 20),
                Text('Aceitação dos Termos de uso.',
                ...
                SizedBox(height: 20),
                Text('Alteração do Serviço e Rescisão.',
                    style: TextStyle(fontSize: 20)),
                SizedBox(height: 10),
                Text(
                ...
                SizedBox(height: 20),
                Text('Segurança; suas interações com outros membros.',
                    style: TextStyle(fontSize: 20)),
                SizedBox(height: 10),
                Text(
                ...
                SizedBox(height: 20),
                Text('Conteúdo de outros membros.',
                    style: TextStyle(fontSize: 20)),
                SizedBox(height: 10),
                Text(
